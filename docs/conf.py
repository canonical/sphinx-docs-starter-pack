...
project = "Kernel team staging docs"
...
ogp_site_url = "https://canonical-kteam-docs-staging.readthedocs-hosted.com/"
...
html_context = {
    ...
    "github_url": "https://github.com/canonical/kteam-docs-staging",
