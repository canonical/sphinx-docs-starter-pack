...
changes the builder, the sitemap will mangle the links. Either update to the
latest version of the Starter Pack or ensure your project's recipes use the
``dirhtml`` builder, not ``html``.
