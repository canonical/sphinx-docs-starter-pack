.. _optional-customisation:

Optional customisation
------------------------

After the initial setup, you can customize your documentation to fit your project's needs. 
This includes adding extensions, modifying the build process, and adding custom templates.
